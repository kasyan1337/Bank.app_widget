...
def test_last_five_raw(raw_data):
    transactions = functions.last_five_raw(raw_data)
...
def test_last_five_formatted(raw_data):
    assert functions.last_five_formatted(raw_data) == ("08.12.2019 Открытие вклада\n"
                                                       "-> Счет **5907\n41096.24 USD\n"
